...
namespace Coffee.UIExtensions
{
	...
	public class ParameterTexture
	{
		...
		/// <summary>
		/// Register the specified transform.
		/// </summary>
...
//				Debug.LogFormat("<color=green>@@@ Register {0} : {1}</color>", transform, transform.parameterIndex);
			}
		}

		/// <summary>
		/// Unregister the specified transform.
		/// </summary>
		/// <param name="target">Target.</param>
		public void Unregister(IParameterTexture target)
		{
			...
			{
//				Debug.LogFormat("<color=red>@@@ Unregister {0} : {1}</color>", transform, transform.parameterIndex);
